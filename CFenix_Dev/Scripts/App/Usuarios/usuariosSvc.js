copisteriaFenixApp.service('User', ['$http', '$cookieStore', function User($http, $cookieStore) {
    //rsanch cambiar para probar en distintos servidores.
    //var serviceBase = 'http://192.168.1.105:8084/';
    //var serviceBase = 'http://localhost:52758/';
    var serviceBase = 'http://cfenix.azurewebsites.net/';
